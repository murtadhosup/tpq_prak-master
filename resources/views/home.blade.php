					...
					<div class="col-md-4">
						...
						<div class="header-left">
							...
							<div class="logo-section smooth-scroll">
								<div class="brand"><a href="#banner">TPQ Al-Mubaroq</a></div>								
							</div>
				...
				<div class="container">
					<div class="row">					 
						<div class="caption-data" style="margin-top: 0px; opacity: 1;" data-animation-effect="fadeIn">
								<h1> AYO MONDOK</h1>
								<h3 class="padding-top30">PESANTRENKU KEREN</h3>
								<div class="padding-top60 contact-form">
									<button class="btn cta-button">Selengkapnya</button>
								</div>
							</div>
					</div>
				</div>
...
<!-- section start --> 
		...
		<section class="section clearfix no-view secPadding" data-animation-effect="fadeIn">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 id="about" class="title text-center">TENTANG <span>MONDOK</span></h1>
						<p class="lead text-center">Hidup adalah perjuangan. Perjuangan adalah perang, perang melawan kebodohan</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-6">
